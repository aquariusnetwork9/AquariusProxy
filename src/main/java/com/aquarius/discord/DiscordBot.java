...
import com.aquarius.command.api.DiscordCommandContext;
import com.aquarius.event.message.DiscordMainChannelCommandReceivedEvent;
...
public class DiscordBot {
    ...
    public void updateBotNickname() {
        if (CONFIG.discord.manageNickname)
            DISCORD.setBotNickname(CONFIG.authentication.username + " | AquariusProxy");
    }
