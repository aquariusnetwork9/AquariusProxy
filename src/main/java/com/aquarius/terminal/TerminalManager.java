...
import com.aquarius.terminal.logback.TerminalConsoleAppender;
...
public class TerminalManager {
    ...
    public void start() {
        if (isRunning.compareAndSet(false, true)) {
            ...
            var terminalThread = new Thread(this::readTerminal, "AquariusProxy Terminal");
