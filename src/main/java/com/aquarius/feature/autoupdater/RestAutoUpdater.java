package com.aquarius.feature.autoupdater;
...
public class RestAutoUpdater extends AutoUpdater {
    ...
    public RestAutoUpdater() {
        this.baseUrl = LAUNCH_CONFIG.repo_owner.equals("rfresh2") && LAUNCH_CONFIG.repo_name.equals("AquariusProxy")
    ...
    public void updateCheck() {
        HttpRequest request = HttpRequest.newBuilder()
            ...
            .headers("User-Agent", "AquariusProxy/" + VERSION)
