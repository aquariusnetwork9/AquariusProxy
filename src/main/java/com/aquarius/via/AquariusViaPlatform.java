...
public class AquariusViaPlatform extends UserConnectionViaVersionPlatform {
    private static final Logger LOGGER = LoggerFactory.getLogger("ViaVersion");
    public AquariusViaPlatform() {
        super(null);
    }

    @Override
    public String getPlatformName() {
        return "AquariusProxy";
    }
    ...
    protected AbstractViaConfig createConfig() {
        var config = new AquariusViaConfig(new File(getDataFolder(), "viaversion.yml"));
        config.reload();
        return config;
    }
