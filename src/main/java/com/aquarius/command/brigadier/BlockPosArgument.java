...
public class BlockPosArgument implements SerializableArgumentType<Coordinates> {
    ...
    public static BlockPos getLoadedBlockPos(CommandContext<com.aquarius.command.api.CommandContext> context, String name) throws CommandSyntaxException {
    ...
    public static BlockPos getBlockPos(CommandContext<com.aquarius.command.api.CommandContext> context, String name) {
