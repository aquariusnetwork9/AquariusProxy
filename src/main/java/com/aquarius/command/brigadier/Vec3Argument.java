...
public class Vec3Argument implements SerializableArgumentType<Coordinates> {
    ...
    public static Vector3d getVec3(CommandContext<com.aquarius.command.api.CommandContext> context, String name) {
        return context.getArgument(name, Coordinates.class).getPosition(context.getSource());
    }

    public static Coordinates getCoordinates(CommandContext<com.aquarius.command.api.CommandContext> context, String name) {
