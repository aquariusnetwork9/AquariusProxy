...
import com.aquarius.mc.Registry;
import com.aquarius.mc.RegistryData;
import com.aquarius.mc.biome.Biome;
import com.aquarius.mc.biome.BiomeRegistry;
...
import com.aquarius.mc.entity.EntityRegistry;
import lombok.Data;
...
public class RegistryDataArgument<T extends RegistryData> implements SerializableArgumentType<RegistryData> {
    ...
    public static <T extends RegistryData> T getRegistryData(final com.mojang.brigadier.context.CommandContext<com.aquarius.command.api.CommandContext> context, String name, Class<T> registryType) {
    ...
    public static EntityData getEntity(final com.mojang.brigadier.context.CommandContext<com.aquarius.command.api.CommandContext> context, String name) {
    ...
    public static EnchantmentData getEnchantment(final com.mojang.brigadier.context.CommandContext<com.aquarius.command.api.CommandContext> context, String name) {
    ...
    public static Biome getBiome(final com.mojang.brigadier.context.CommandContext<com.aquarius.command.api.CommandContext> context, String name) {
