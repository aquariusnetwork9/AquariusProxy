...
public class EnumStringArgumentType implements SerializableArgumentType<String> {
    ...
    public static String getEnumString(final CommandContext<com.aquarius.command.api.CommandContext> context, final String name) throws CommandSyntaxException {
