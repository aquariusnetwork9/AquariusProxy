        ...
        return command("plugins")
            ...
            .then(argument("toggle", toggle()).executes(c -> {
                ...
                c.getSource().getEmbed()
                    ...
                    .description(appendWarningToDescription("Restart AquariusProxy for changes to take effect: `restart`"))
                    .primaryColor();
            }))
            ...
            .then(literal("download").then(argument("url", wordWithChars()).executes(c -> {
                ...
                String desc = "Restart AquariusProxy to reload plugins: `restart`";
