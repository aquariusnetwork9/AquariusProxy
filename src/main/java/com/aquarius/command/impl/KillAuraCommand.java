...
import com.aquarius.module.impl.KillAura;
import com.aquarius.util.config.Config;
import com.aquarius.util.config.Config.Client.Extra.KillAura.WeaponMaterial;
import com.aquarius.util.config.Config.Client.Extra.KillAura.WeaponType;
