        ...
        builder.then(literal("whitelist")
                ...
                .then(literal("add")
                        .then(argument("playerName", wordWithChars()).executes(c -> {
                            ...
                            CONFIG.client.extra.pearlPlus.whitelist.put(uuid, new com.aquarius.util.config.Config.Client.Extra.PearlPlus.WhitelistedPlayer(playerName, uuid));
                ...
                .then(literal("list").executes(c -> {
                    ...
                    for (com.aquarius.util.config.Config.Client.Extra.PearlPlus.WhitelistedPlayer player : CONFIG.client.extra.pearlPlus.whitelist.values()) {
