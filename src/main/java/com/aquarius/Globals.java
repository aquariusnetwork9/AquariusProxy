...
import com.aquarius.cache.DataCache;
import com.aquarius.command.CommandManager;
import com.aquarius.database.DatabaseManager;
import com.aquarius.discord.DiscordBot;
import com.aquarius.feature.gui.InGameGuiManager;
import com.aquarius.feature.inventory.InventoryManager;
import com.aquarius.feature.pathfinder.Baritone;
import com.aquarius.feature.player.Bot;
import com.aquarius.feature.player.InputManager;
import com.aquarius.feature.tasks.*;
import com.aquarius.feature.tps.TPSCalculator;
import com.aquarius.feature.whitelist.PlayerListsManager;
import com.aquarius.mc.block.BlockDataManager;
import com.aquarius.mc.entity.EntityDataManager;
import com.aquarius.mc.language.TranslationRegistryInitializer;
import com.aquarius.mc.map.MapBlockColorManager;
import com.aquarius.module.ModuleManager;
import com.aquarius.network.server.handler.player.InGameCommandManager;
import com.aquarius.plugin.DefaultGsonConfigSerializer;
import com.aquarius.plugin.PluginManager;
import com.aquarius.plugin.api.ConfigSerializer;
import com.aquarius.terminal.TerminalManager;
import com.aquarius.util.KotlinUtil;
import com.aquarius.util.Wait;
import com.aquarius.util.AquariusScheduledExecutor;
import com.aquarius.util.config.Config;
import com.aquarius.util.config.ConfigVerifier;
import com.aquarius.util.config.LaunchConfig;
import com.aquarius.via.AquariusViaInitializer;
...
public class Globals {
    ...
    public static final ComponentLogger STASH_LOG = ComponentLogger.logger("Stash");
    ...
    public static final AquariusViaInitializer VIA_INITIALIZER;
    ...
    static {
        try {
            ...
            EXECUTOR = new AquariusScheduledExecutor(4, new ThreadFactoryBuilder()
            ...
            EVENT_BUS = new SimpleEventBus(Executors.newFixedThreadPool(2, new ThreadFactoryBuilder()
                .setNameFormat("AquariusProxy Async EventBus - #%d")
                .setDaemon(true)
