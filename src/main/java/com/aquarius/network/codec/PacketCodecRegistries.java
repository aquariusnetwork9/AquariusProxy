package com.aquarius.network.codec;

import com.aquarius.network.client.handler.incoming.*;
import com.aquarius.network.client.handler.incoming.entity.*;
import com.aquarius.network.client.handler.incoming.inventory.*;
import com.aquarius.network.client.handler.incoming.level.*;
import com.aquarius.network.client.handler.incoming.scoreboard.*;
import com.aquarius.network.client.handler.incoming.spawn.AddEntityHandler;
import com.aquarius.network.client.handler.incoming.spawn.AddExperienceOrbHandler;
import com.aquarius.network.client.handler.incoming.spawn.SpawnPositionHandler;
import com.aquarius.network.client.handler.outgoing.*;
import com.aquarius.network.client.handler.postoutgoing.*;
import com.aquarius.network.server.ServerSession;
import com.aquarius.network.server.handler.player.incoming.*;
import com.aquarius.network.server.handler.player.outgoing.ClientCommandsOutgoingHandler;
import com.aquarius.network.server.handler.player.postoutgoing.LoginPostHandler;
import com.aquarius.network.server.handler.shared.incoming.*;
import com.aquarius.network.server.handler.shared.outgoing.*;
import com.aquarius.network.server.handler.shared.postoutgoing.*;
import com.aquarius.network.server.handler.spectator.incoming.*;
import com.aquarius.network.server.handler.spectator.incoming.movement.PlayerPositionRotationSpectatorHandler;
import com.aquarius.network.server.handler.spectator.incoming.movement.PlayerPositionSpectatorHandler;
import com.aquarius.network.server.handler.spectator.incoming.movement.PlayerRotationSpectatorHandler;
import com.aquarius.network.server.handler.spectator.outgoing.*;
import com.aquarius.network.server.handler.spectator.postoutgoing.LoginSpectatorPostHandler;
