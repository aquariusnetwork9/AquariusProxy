...
import com.aquarius.event.client.ClientOnlineEvent;
import com.aquarius.event.queue.QueueCompleteEvent;
import com.aquarius.event.queue.QueueStartEvent;
import com.aquarius.event.server.MotdBuildEvent;
...
public class AquariusServerInfoBuilder {
    public static final AquariusServerInfoBuilder INSTANCE = new AquariusServerInfoBuilder();
    ...
    private AquariusServerInfoBuilder() {
        EVENT_BUS.subscribe(
            this,
    ...
    private VersionInfo getVersionInfo(@Nullable Session session) {
        ...
        return new VersionInfo("AquariusProxy", protocolId);
    }
