package com.aquarius.network.client;
...
import com.aquarius.network.ClientKeepAliveTask;
import com.aquarius.network.ClientPacketPingTask;
import com.aquarius.network.ClientPongTask;
...
import static com.aquarius.via.AquariusViaInitializer.VIA_USER;
...
public class ClientSession extends TcpClientSession {
    ...
    private void updateClientProtocolVersion() {
        var nativeAquariusProtocol = ProtocolVersion.getProtocol(MinecraftCodec.CODEC.getProtocolVersion());;
        var clientProtocolVersion = nativeAquariusProtocol;
