 ...
 * the bot is mining. Enabling it registers {@link AquariusSnifferCodec} into ZenithProxy's CLIENT registry (bot
...
public class AquariusSniffer extends Module {
    ...
    /** Print the rolling buffer to the console/terminal log (where ZenithProxy packet logs go). */
    public void dump() {
